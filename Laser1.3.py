...
class Main:
    ...
    def laserAuto(self):
        ...
        self.checkShot()                            # Moved checkshot() and if's below, from invaderAuto to laserAuto.
        if self.checkShot == True:                  # checkShot wasn't functioning in some cases, probably because
            self.canvas.delete(self.laser)          # checkShot was only called everytime the invader was moving.
